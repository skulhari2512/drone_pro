...
;
;
// Built-in UI Components (exactly matching your original)
const Card = (param)=>{
    let { children, className = '' } = param;
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "bg-white border rounded-lg shadow-sm ".concat(className),
        children: children
    }, void 0, false, {
...
_c1 = CardContent;
const Button = (param)=>{
    let { children, onClick, disabled = false, variant = 'default', className = '' } = param;
...
const Progress = (param)=>{
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "w-full bg-gray-200 rounded-full h-2 ".concat(className),
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_c3 = Progress;
// Mock quiz questions (exactly from your original)
const mockQuizQuestions = [
    {
        id: 1,
        question: "What's your primary goal with drone technology?",
        options: [
            {
                id: 1,
                value: "hobby",
                text: "Personal hobby and recreation"
            },
            {
                id: 2,
                value: "career_change",
                text: "Career change to drone industry"
            },
            {
                id: 3,
                value: "business_expansion",
                text: "Expand existing business services"
            },
            {
                id: 4,
                value: "professional_skill",
                text: "Add professional skills"
            }
        ]
    },
    {
    ...
    },
    {
        ...
        options: [
            ...
            },
            {
                ...
                text: "Some recreational flying"
            },
            {
                id: 3,
                value: "intermediate",
                text: "Intermediate hobbyist"
            },
            {
                id: 4,
                value: "experienced",
    ...
    },
    {
        ...
        options: [
            ...
            },
            {
                id: 2,
                value: "online",
                text: "Online self-paced learning"
            },
            {
                id: 3,
                value: "classroom",
                text: "Traditional classroom setting"
            },
            {
                id: 4,
                value: "mixed",
    ...
    {
        id: 5,
        question: "What's your budget range for training?",
        options: [
            {
                id: 1,
            ...
            },
            {
                id: 4,
                value: "comprehensive",
                text: "Over $5,000 for comprehensive training"
            }
        ]
    }
];
// Local storage functions for Next.js (exactly from your original)
const saveQuizProgress = (answers)=>{
    if ("TURBOPACK compile-time truthy", 1) {
        localStorage.setItem('droneQuizAnswers', JSON.stringify(answers));
...
const getQuizProgress = ()=>{
    if ("TURBOPACK compile-time truthy", 1) {
        const saved = localStorage.getItem('droneQuizAnswers') || localStorage.getItem('quizProgress');
...
const clearQuizProgress = ()=>{
    if ("TURBOPACK compile-time truthy", 1) {
        localStorage.removeItem('droneQuizAnswers');
...
const Quiz = ()=>{
    ...
    const toast = (param)=>{
        ...
        alert("".concat(title, ": ").concat(description));
    };
    const handleDownloadPDF = async ()=>{
        ...
        try {
            // Save user data along with quiz answers
            const userData = {
                name: formData.name,
            ...
            // Save to localStorage for the plan page to read
            if ("TURBOPACK compile-time truthy", 1) {
                localStorage.setItem('userData', JSON.stringify(userData));
                localStorage.setItem('droneQuizAnswers', JSON.stringify(answers));
                localStorage.setItem('quizCompleted', 'true');
            }
            console.log('User data and quiz answers saved:', userData);
            // Simulate API call delay
            await new Promise((resolve)=>setTimeout(resolve, 2000));
            toast({
                title: "Success!",
                description: "Your personalized career plan is ready. Redirecting to your plan..."
            });
            setShowCongratulationsPopup(false);
            setFormData({
                name: '',
                ...
                children: [
                                ...
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(CardContent, {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                                            ...
                                            children: mockQuizQuestions[currentQuestion].question
                                        }, void 0, false, {
                                            fileName: "[project]/components/pages/Quiz.jsx",
                                            lineNumber: 351,
                                            columnNumber: 17
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: "space-y-4",
                                            children: mockQuizQuestions[currentQuestion].options.map((option)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["motion"].div, {
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: mockQuizQuestions.map((_, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(Quiz, "h6rkuJZWYPY6Nyq3qwkoG36S+ww=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$router$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
...
__turbopack_context__.k.register(_c3, "Progress");
__turbopack_context__.k.register(_c4, "Quiz");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__503d8623._.js.map