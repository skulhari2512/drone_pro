...
const Quiz = ()=>{
    ...
    const handleDownloadPDF = async ()=>{
        ...
        try {
            ...
            const response = await fetch("".concat(("TURBOPACK compile-time value", "https://ymrtlcyafzuotngltgcb.supabase.co"), "/functions/v1/resend-email"), {
                method: 'POST',
                headers: {
                    ...
                    'Authorization': "Bearer ".concat(("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InltcnRsY3lhZnp1b3RuZ2x0Z2NiIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTczMjU4MjAsImV4cCI6MjA3MjkwMTgyMH0.-BgOxU6DJe8wF0N_tbBeNpVmHtvfv0BG6YcuzPLK1Gc"))
                },
                body: JSON.stringify({
                    // For testing: always send to your verified email address
                    to: 'suman6012@gmail.com',
                    from: 'onboarding@dronecareerpro.com',
                    subject: "Your Personalized Drone Career Plan - ".concat(generatedPlan.title),
                    html: '\n            <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">\n              <h2 style="color: #333;">Your Personalized Drone Career Plan</h2>\n              <p>Hi '.concat(formData.name, ',</p>\n              <p>Thank you for completing our career assessment! Here\'s your personalized plan:</p>\n              \n              <div style="background: #f5f5f5; padding: 20px; border-radius: 8px; margin: 20px 0;">\n                <h3>').concat(generatedPlan.title, "</h3>\n                <p><strong>Industry:</strong> ").concat(generatedPlan.industry, "</p>\n                <p><strong>Description:</strong> ").concat(generatedPlan.description, "</p>\n                \n                ").concat(generatedPlan.marketOpportunities ? "\n                  <h4>Market Opportunities:</h4>\n                  <p>".concat(generatedPlan.marketOpportunities, "</p>\n                ") : '', "\n                \n                ").concat(generatedPlan.whyNow ? "\n                  <h4>Why Now:</h4>\n                  <p>".concat(generatedPlan.whyNow, "</p>\n                ") : '', "\n              </div>\n              \n              <p><strong>Contact Information:</strong><br>\n              Name: ").concat(formData.name, "<br>\n              Email: ").concat(formData.email, "<br>\n              Phone: ").concat(formData.phone, "</p>\n              \n              <p>We'll be in touch soon with more information about our training programs.</p>\n              <p>Best regards,<br>Your Drone Career Team</p>\n            </div>\n          "),
                    templateData: {
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$jsx__$5b$client$5d$__$28$ecmascript$29$__["Card"], {
                                ...
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$jsx__$5b$client$5d$__$28$ecmascript$29$__["CardContent"], {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: "space-y-4",
                                            children: question.options.map((option)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                    onClick: ()=>handleAnswerSelect(option.value),
                                                    className: "w-full p-4 text-left rounded-xl border-2 transition-all duration-200 hover:scale-[1.02] focus:outline-none focus:ring-2 focus:ring-blue-500 ".concat(selectedOption === option.value ? 'border-slate-900 bg-slate-50 text-slate-900' : 'border-slate-200 bg-white hover:border-slate-300 hover:bg-slate-50'),
                                                    role: "radio",
                                                    ...
                                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: [
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                className: "w-5 h-5 rounded-full border-2 mr-4 flex items-center justify-center transition-colors ".concat(selectedOption === option.value ? 'border-slate-900 bg-slate-900' : 'border-slate-300'),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e2317fc2._.js.map