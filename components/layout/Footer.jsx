          ...
          <div className="col-span-1 md:col-span-2">
            <Link href="/" legacyBehavior>
              <a className="flex items-center space-x-2 mb-4">
                <div className="relative w-10 h-10">
                  <Image
                    src="/images/dronelogo.png" // Update path after moving to public folder
            ...
            <div className="space-y-2">
              <div className="flex items-center space-x-2 text-slate-300">
                ...
                <span>cooper@dronecareerpro.au</span>
              </div>
              <div className="flex items-center space-x-2 text-slate-300">
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/how-it-works" legacyBehavior>
                  <a className="text-slate-300 hover:text-white transition-colors duration-200">
                    How It Works
                  </a>
                </Link>
              </li>
              <li>
                <Link href="/industry-uses" legacyBehavior>
                  <a className="text-slate-300 hover:text-white transition-colors duration-200">
                    Industries
                  </a>
                </Link>
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-gradient-to-r from-blue-500/90 to-purple-900/90 backdrop-blur-md border-t border-white/30 py-3 z-50 shadow-xl">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-3">
            ...
            <Link href="/quiz" legacyBehavior>
              <a>
                <button className="bg-white text-blue-600 font-semibold px-5 py-2.5 rounded-xl hover:bg-blue-50 transition-all duration-300 hover:scale-105 shadow-lg">
                   Start Your Journey →
                </button>
              </a>
            </Link>
